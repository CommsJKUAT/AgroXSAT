...
from .views import homepage,soilprecipitation,soilphapi,smokeapi,batteryapi,humidityapi,locationapi,imagesapi,groundstationCoordinates,get_gs
...
urlpatterns = [
    ...
    path('temperature/', humidityapi.as_view(), name="temperature"),  
    ...
    path('mapgs/', humidityapi.as_view(), name="stationOnMap"), 
